...
# Input files
files_photons = glob('/data_CMS_upgrade/sauvan/HGCAL/2204_BCSTC-FE-studies/DoublePhoton_FlatPt-1To100/GammaGun_Pt1_100_PU0_HLTSummer20ReRECOMiniAOD_2204_BCSTC-FE-studies_v3-29-1_oldfe/220808_135302/ntuple_*.root')
files_electrons = glob('/data_CMS_upgrade/sauvan/HGCAL/2204_BCSTC-FE-studies/DoubleElectron_FlatPt-1To100/ElectronGun_Pt1_100_PU200_HLTSummer20ReRECOMiniAOD_2204_BCSTC-FE-studies_v3-29-1_oldfe/220810_095459/ntuple_*.root')
files_pions = [] 
if local:
...
bestmatch_only = True
output_dir = '/data_CMS_upgrade/sauvan/HGCAL/2204_BCSTC-FE-studies/preprocessed-dataframes/3-29-1/oldfe/electrons_photons/'
file_per_batch_electrons = 5
file_per_batch_pions = 2
file_per_batch_photons = 2
algo_trees = {}
# List of ECON algorithms
fes = ['Threshold0', 'Threshold', 'Mixedbcstcsig4',
        ]
