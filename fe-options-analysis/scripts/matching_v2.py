...
def openroot(files, algo_trees, gen_tree):
    ...
    for filename in files:
        ...
        for algo_name, algo_tree in algo_trees.items():
            ...
            #  print(tree.arrays(['cl3d_layer_pt'], library='np'))
            #  print(tree.arrays(['cl3d_layer_pt'], library='np')['cl3d_layer_pt'])
            #  print(tree.arrays(['cl3d_layer_pt'], library='np')['cl3d_layer_pt'].tolist())
            #  print(chain.from_iterable(tree.arrays(['cl3d_layer_pt'], library='np')['cl3d_layer_pt'].tolist()))
            #  print(list(chain.from_iterable(tree.arrays(['cl3d_layer_pt'], library='np')['cl3d_layer_pt'].tolist())))
            df_cl['cl3d_layer_pt'] = list(chain.from_iterable(tree.arrays(['cl3d_layer_pt'], library='np')['cl3d_layer_pt'].tolist()))
